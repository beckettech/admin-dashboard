...
export function FollowUpPage() {
  ...
  const sendFollowUp = async (lead: Lead) => {
    ...
    const promoHtml = `<div style="background:#f0fdf4;border:1px solid #22c55e;border-radius:8px;padding:12px 16px;margin:16px 0;"><p style="margin:0;font-size:15px;">🎁 <strong>New offer for local businesses</strong> — we just launched a locals-only deal. Use code <code style="background:#dcfce7;padding:2px 8px;border-radius:4px;font-weight:bold;">SWFL50</code> at checkout for <strong>50% off every month</strong>.</p></div>`;
                ...
                {followUpLead?.id === lead.id && (
                  <div className="mt-4 pt-4 border-t border-slate-700">
                    ...
                    <div className="bg-slate-900/50 rounded-lg p-3 mb-3 space-y-2">
                      ...
                      <div className="text-green-400 text-xs">🎁 Locals-only offer included (SWFL50 for 50% off)</div>
                    </div>
                    <div
